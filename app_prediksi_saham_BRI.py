...
def main():
    print("Aplikasi Prediksi Saham BRI (BBRI.JK) dengan Model Gerald")

    path_model = os.path.join('models', 'model_prediksi_saham_BRI_linear.pkl')
    ...
    if not os.path.exists(path_model):
        ...
        print("Pastikan file ini (aplikasi_saham_pintar.py) ada di folder utama,")
    ...
    try:
        ...
        print("\n" + "-"*40)
        print(f"Prediksi Harga Saham Bank BRI untuk hari besok kerja:")
